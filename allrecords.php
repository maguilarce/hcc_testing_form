                    ...
                    <table style='font-size:11px' class="table table-list-search table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:5%;font-size:13px"><?php echo $th; ?></th>
...
//$sqlol = "SELECT * FROM paper_testing WHERE";
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $edit_link = '';
                                if ($_SESSION['id_type'] != '1' && $_SESSION['id_type'] != '2') { //if it is faculty
                                    $edit_link = "<td id='row_val" . $row['id'] . "'>" . "<a href='edit.php?id=" . $row['id'] . "'>Edit Record</td>";
                                } else { //if it is admin
                                    $edit_link = "<td id='row_val" . $row['id'] . "'>" . "<a href='edit.php?id=" . $row['id'] . "'>" . $row['id'] . "</a>" . "</td>";
                                }
